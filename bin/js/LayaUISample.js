var GameMain = /** @class */ (function () {
    ...
    GameMain.prototype.onLoaded = function () {
        ...
        this.mouse = this.mngBoard.getChildByName("mouse");
        this.boardPosArr = this.mngBoard.boardPosArr;
        this.mouseY = this.mouse.y + this.mngBoard.y;
    };
    GameMain.prototype.onOneStep = function () {
        this.changeMouse(this.mouseI, this.mouseI + 1);
        this.mouseI += 1;
    };
    GameMain.prototype.onTwoStep = function () {
        this.changeMouse(this.mouseI, this.mouseI + 2);
        this.mouseI += 2;
    };
    GameMain.prototype.changeMouse = function (I, lastI) {
    ...
    GameMain.prototype.onLoop = function (x2, y2, lastI) {
        ...
        if (this.vY < 0 && this.mouse.y > y2) {
            ...
            this.mouse.x = x2;
            this.mouse.y = y2;
            var curBoard = this.mngBoard.getChildAt(lastI - 1);
            if (curBoard.type == 0) {
